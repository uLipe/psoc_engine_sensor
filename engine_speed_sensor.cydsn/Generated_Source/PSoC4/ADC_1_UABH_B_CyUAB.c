...
* @endinternal
*
* @param uabSram starting address of UAB half waveform SRAM; ie ADC_1_UABH_B_SRAM1_PTR
* @param pattern clocking in LSbit to MSbit ordering for step 0 to step 15.
* When the @p modbitPattern is high, the
* modbit waveform (chosen by ADC_1_UABH_B_SetModbitSource()) is used as
