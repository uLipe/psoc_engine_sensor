...
uint32 ADC_1_UABH_B_initVar = 0UL; /**< 0 if component is uninitialized. 1 otherwise. */
...
/*! Part of default configuration used to initialize UAB in ADC_1_UABH_B_Start() */
uint16 ADC_1_UABH_B_waveConfig[ADC_1_UABH_B_NUM_STEPS] = {
/*0<=last_step<=15 , so always at least one step*/
((uint16)ADC_1_UABH_B_PARAM_WAVE_STEP_0)

#if ADC_1_UABH_B_INC_STEP_1
,((uint16)ADC_1_UABH_B_PARAM_WAVE_STEP_1)
#endif
#if ADC_1_UABH_B_INC_STEP_2
,((uint16)ADC_1_UABH_B_PARAM_WAVE_STEP_2)
#endif
#if ADC_1_UABH_B_INC_STEP_3
,((uint16)ADC_1_UABH_B_PARAM_WAVE_STEP_3)
#endif
#if ADC_1_UABH_B_INC_STEP_4
,((uint16)ADC_1_UABH_B_PARAM_WAVE_STEP_4)
#endif
#if ADC_1_UABH_B_INC_STEP_5
,((uint16)ADC_1_UABH_B_PARAM_WAVE_STEP_5)
#endif
#if ADC_1_UABH_B_INC_STEP_6
,((uint16)ADC_1_UABH_B_PARAM_WAVE_STEP_6)
#endif
#if ADC_1_UABH_B_INC_STEP_7
,((uint16)ADC_1_UABH_B_PARAM_WAVE_STEP_7)
#endif
#if ADC_1_UABH_B_INC_STEP_8
,((uint16)ADC_1_UABH_B_PARAM_WAVE_STEP_8)
#endif
#if ADC_1_UABH_B_INC_STEP_9
,((uint16)ADC_1_UABH_B_PARAM_WAVE_STEP_9)
#endif
#if ADC_1_UABH_B_INC_STEP_10
,((uint16)ADC_1_UABH_B_PARAM_WAVE_STEP_10)
#endif
#if ADC_1_UABH_B_INC_STEP_11
,((uint16)ADC_1_UABH_B_PARAM_WAVE_STEP_11)
#endif
#if ADC_1_UABH_B_INC_STEP_12
,((uint16)ADC_1_UABH_B_PARAM_WAVE_STEP_12)
#endif
#if ADC_1_UABH_B_INC_STEP_13
,((uint16)ADC_1_UABH_B_PARAM_WAVE_STEP_13)
#endif
#if ADC_1_UABH_B_INC_STEP_14
,((uint16)ADC_1_UABH_B_PARAM_WAVE_STEP_14)
#endif
#if ADC_1_UABH_B_INC_STEP_15
,((uint16)ADC_1_UABH_B_PARAM_WAVE_STEP_15)
#endif
};

/*! Part of default configuration used to initialize UAB in ADC_1_UABH_B_Start() */
CyUAB_reg_pair ADC_1_UABH_B_initPairs[ADC_1_UABH_B_INIT_PAIRS_COUNT] = {

	/*OA_CTRL default always first element in initPairs*/
#if ADC_1_UABH_B_NONZERO_OA_CTRL
    {ADC_1_UABH_B_OA_CTRL_PTR         , ((uint32)ADC_1_UABH_B_DEFAULT_OA_CTRL)}
#endif
#if ADC_1_UABH_B_NONZERO_SW_STATIC
    ,{ADC_1_UABH_B_SW_STATIC_PTR      , ((uint32)ADC_1_UABH_B_DEFAULT_SW_STATIC)}
#endif
#if ADC_1_UABH_B_NONZERO_SW_MODBIT_SRC
    ,{ADC_1_UABH_B_SW_MODBIT_SRC_PTR  , ((uint32)ADC_1_UABH_B_DEFAULT_SW_MODBIT_SRC)}
#endif
#if ADC_1_UABH_B_NONZERO_SRAM_CTRL
    ,{ADC_1_UABH_B_SRAM_CTRL_PTR      , ((uint32)ADC_1_UABH_B_DEFAULT_SRAM_CTRL)} 
#endif
...
#if ADC_1_UABH_B_NONZERO_INTR_MASK	
    ,{ADC_1_UABH_B_INTR_MASK_PTR      , ((uint32)ADC_1_UABH_B_DEFAULT_INTR_MASK)}
#endif
#if ADC_1_UABH_B_NONZERO_CAP_CTRL
    ,{ADC_1_UABH_B_CAP_CTRL_PTR       , ((uint32)ADC_1_UABH_B_DEFAULT_CAP_CTRL)}
#endif
#if ADC_1_UABH_B_NONZERO_CAP_ABCF_VAL
    ,{ADC_1_UABH_B_CAP_ABCF_VAL_PTR   , ((uint32)ADC_1_UABH_B_DEFAULT_CAP_ABCF_VAL)}
#endif
#if ADC_1_UABH_B_NONZERO_CAP_AB_VAL_NXT
    ,{ADC_1_UABH_B_CAP_AB_VAL_NXT_PTR , ((uint32)ADC_1_UABH_B_DEFAULT_CAP_AB_VAL_NXT)}
#endif
#if ADC_1_UABH_B_NONZERO_CAP_CF_VAL_NXT
    ,{ADC_1_UABH_B_CAP_CF_VAL_NXT_PTR , ((uint32)ADC_1_UABH_B_DEFAULT_CAP_CF_VAL_NXT)}
#endif
#if ADC_1_UABH_B_NONZERO_STARTUP_DELAY
    ,{ADC_1_UABH_B_STARTUP_DELAY_PTR  , ((uint32)ADC_1_UABH_B_DEFAULT_STARTUP_DELAY)}
#endif
#if ADC_1_UABH_B_NONZERO_SUBSAMPLE_CTRL
    ,{ADC_1_UABH_B_SUBSAMPLE_CTRL_PTR , ((uint32)ADC_1_UABH_B_DEFAULT_SUBSAMPLE_CTRL)}
#endif
#if ADC_1_UABH_B_NONZERO_SW_CA_IN0
    ,{ADC_1_UABH_B_SW_CA_IN0_PTR      , ((uint32)ADC_1_UABH_B_DEFAULT_SW_CA_IN0)}
#endif
#if ADC_1_UABH_B_NONZERO_SW_CA_IN1
    ,{ADC_1_UABH_B_SW_CA_IN1_PTR      , ((uint32)ADC_1_UABH_B_DEFAULT_SW_CA_IN1)}
#endif
#if ADC_1_UABH_B_NONZERO_SW_CA_TOP
    ,{ADC_1_UABH_B_SW_CA_TOP_PTR      , ((uint32)ADC_1_UABH_B_DEFAULT_SW_CA_TOP)}
#endif
#if ADC_1_UABH_B_NONZERO_SW_CB_IN0
    ,{ADC_1_UABH_B_SW_CB_IN0_PTR      , ((uint32)ADC_1_UABH_B_DEFAULT_SW_CB_IN0)}
#endif
#if ADC_1_UABH_B_NONZERO_SW_CB_IN1
    ,{ADC_1_UABH_B_SW_CB_IN1_PTR      , ((uint32)ADC_1_UABH_B_DEFAULT_SW_CB_IN1)}
#endif
#if ADC_1_UABH_B_NONZERO_SW_CB_TOP
    ,{ADC_1_UABH_B_SW_CB_TOP_PTR      , ((uint32)ADC_1_UABH_B_DEFAULT_SW_CB_TOP)}
#endif
#if ADC_1_UABH_B_NONZERO_SW_CC_IN0
    ,{ADC_1_UABH_B_SW_CC_IN0_PTR      , ((uint32)ADC_1_UABH_B_DEFAULT_SW_CC_IN0)}
#endif
#if ADC_1_UABH_B_NONZERO_SW_CC_IN1
    ,{ADC_1_UABH_B_SW_CC_IN1_PTR      , ((uint32)ADC_1_UABH_B_DEFAULT_SW_CC_IN1)}
#endif
#if ADC_1_UABH_B_NONZERO_SW_CC_TOP
    ,{ADC_1_UABH_B_SW_CC_TOP_PTR      , ((uint32)ADC_1_UABH_B_DEFAULT_SW_CC_TOP)}
#endif
#if ADC_1_UABH_B_NONZERO_SW_CF_BOT
    ,{ADC_1_UABH_B_SW_CF_BOT_PTR      , ((uint32)ADC_1_UABH_B_DEFAULT_SW_CF_BOT)}
#endif
#if ADC_1_UABH_B_NONZERO_SW_OTHER
    ,{ADC_1_UABH_B_SW_OTHER_PTR       , ((uint32)ADC_1_UABH_B_DEFAULT_SW_OTHER)}
#endif
#if ADC_1_UABH_B_NONZERO_SW_BOOST_CTRL
...
/*! Default configuration used to initialize UAB in ADC_1_UABH_B_Start() */
CyUAB_config ADC_1_UABH_B_config = {
    ADC_1_UABH_B_waveConfig,
    ADC_1_UABH_B_initPairs,
    ...
    (uint8)(ADC_1_UABH_B_ELEMENT_COUNT(ADC_1_UABH_B_initPairs))
};
...
* ADC_1_UABH_B_Enable(), ADC_1_UABH_B_Init(&ADC_1_UABH_B_config), and ADC_1_UABH_B_Run(1UL).  
...
* @endinternal
* 
* @see ADC_1_UABH_B_Enable()
* @see ADC_1_UABH_B_Init()
* @see ADC_1_UABH_B_Run()
* @see ADC_1_UABH_B_Stop()
*
* @sideeffect Sets ENABLED bit for whole UAB - both half0 and half1.
*
* \globalvars
*  \ref ADC_1_UABH_B_initVar (RW)
*
*******************************************************************************/
void ADC_1_UABH_B_Start(void)
{
    if (ADC_1_UABH_B_initVar != 1UL)
    {
        ADC_1_UABH_B_Init(&ADC_1_UABH_B_config);
        ADC_1_UABH_B_initVar = 1UL;
    }
    else 
    {
    ...
    ADC_1_UABH_B_Run(1UL); /*set the run bit*/
}
...
{
    ADC_1_UABH_B_Run(0UL); /*Clear run bit*/
...
void ADC_1_UABH_B_Init(const CyUAB_config * cfg)
{
    ...
    CyUAB_SetNSteps( ADC_1_UABH_B_SRAM0_PTR, ((size_t)(cfg->stepCount)), (cfg->waveSteps) );
    
    /* Optimized version of ClearAllClocks() -- 
    Clear remaining wavesteps, so clock editing with SetClock() works
    */
    (void)CyUAB_wordset( 
        ((reg32*)( ((uint32)(ADC_1_UABH_B_SRAM0_PTR)) + (((uint32)(cfg->stepCount))*sizeof(uint32)) )), 
        0UL, 
        ( ( CyUAB_STEPS_LEN_MAX - ((uint32)(cfg->stepCount)) ) * sizeof(uint32) )
    );
    
    ADC_1_UABH_B_WriteInitPairs( cfg->pairs, ((size_t)(cfg->pairCount)) );
    /* ^ 
    *  | 
    *  | 
    *  Direct writes must happen before writing shared switch fields*/
    ...
    ADC_1_UABH_B_SetAgndTied( agndTied );
    refTied = CyUAB_SHARED_SW_CFG_REFTIED(  cfg->shared_sw );
    ADC_1_UABH_B_SetRefTied( refTied );
    clk_AA = CyUAB_SHARED_SW_CFG_AA(  cfg->shared_sw );
    ADC_1_UABH_B_SetSwitch( CyUAB_SW_AA, clk_AA );
    clk_BB = CyUAB_SHARED_SW_CFG_BB(  cfg->shared_sw );
    ADC_1_UABH_B_SetSwitch( CyUAB_SW_BB, clk_BB );
    clk_CC = CyUAB_SHARED_SW_CFG_CC(  cfg->shared_sw );
    ADC_1_UABH_B_SetSwitch( CyUAB_SW_CC, clk_CC );
#endif
...
* How to disable:
* ADC_1_UABH_B_UAB_CTRL_REG &= ~ADC_1_UABH_B_ENABLED_MASK;
*
...
* @see ADC_1_UABH_B_Start()
* @see ADC_1_UABH_B_Init()
* @see ADC_1_UABH_B_SetUABPower()
* @see ADC_1_UABH_B_SetOAPower()
* @see ADC_1_UABH_B_SetCompPower()
* @see ADC_1_UABH_B_SetRefPower()
* @see ADC_1_UABH_B_SetAgndPower()
* 
* @sideeffect Sets ENABLED bit for whole UAB - both half0 and half1.
*******************************************************************************/
void ADC_1_UABH_B_Enable(void)
{
    ADC_1_UABH_B_UAB_CTRL_REG |= ADC_1_UABH_B_ENABLED_MASK; /*Side effect: also enables other UAB half in same pair*/
}
...
*
* @internal
* @reglist @reg ADC_1_UABH_B_INTR_REG
* @endinternal
* 
* @see ADC_1_UABH_B_SetInterrupt()
* 
* @see ADC_1_UABH_B_SetInterruptMask()
* @see ADC_1_UABH_B_ClearInterruptMask()
* @see ADC_1_UABH_B_GetInterruptIsMasked()
* 
* @sideeffect None
*******************************************************************************/
void ADC_1_UABH_B_ClearInterrupt(CyUAB_intr_enum intr)
{
    ...
    uint32 mask = ( (CyUAB_INTR_COMP==intr)      ? ((uint32)ADC_1_UABH_B_INTR_COMP_MASK) : 
                  ( (CyUAB_INTR_VDAC_EMPTY==intr)? ((uint32)ADC_1_UABH_B_INTR_VDAC_EMPTY_MASK) : 
                  0UL ) );
    if(0UL!=mask)
    {
        *(ADC_1_UABH_B_INTR_PTR) |= mask;    
    }
}

/************* ADC_1_UABH_B_SetInterrupt() ********************************/
/*!
...
*
* @internal
* @reglist @reg ADC_1_UABH_B_INTR_SET_REG
* @endinternal
*
* 
* @see ADC_1_UABH_B_ClearInterrupt()
* @see ADC_1_UABH_B_SetInterruptMask()
* @see ADC_1_UABH_B_ClearInterruptMask()
* @see ADC_1_UABH_B_GetInterruptIsMasked()
* 
...
void ADC_1_UABH_B_SetInterrupt(CyUAB_intr_enum intr)
{
    ...
    if(0UL!=mask)
    {
        *(ADC_1_UABH_B_INTR_SET_PTR) |= mask;
    }
}

/************** ADC_1_UABH_B_SetInterruptMask() ***************************/
/*!
...
*
* @internal
* @reglist @reg ADC_1_UABH_B_INTR_MASK_REG
* @endinternal
* 
* @see ADC_1_UABH_B_SetInterrupt()
* @see ADC_1_UABH_B_ClearInterrupt()
...
void ADC_1_UABH_B_SetInterruptMask(CyUAB_intr_enum intr)
{
    ...
    if(0UL!=mask)
    {
        *(ADC_1_UABH_B_INTR_MASK_PTR) |= mask;    
    }
}

/************* ADC_1_UABH_B_ClearInterruptMask() **************************/
/*!
...
/********** ADC_1_UABH_B_GetInterruptIsMasked() ***************************/
/*!
...
*
* @internal
* @reglist ADC_1_UABH_B_INTR_MASKED_REG
* @endinternal
*
* @see ADC_1_UABH_B_SetInterrupt()
* @see ADC_1_UABH_B_ClearInterrupt()
...
uint32 ADC_1_UABH_B_GetInterruptIsMasked(CyUAB_intr_enum intr)
{
    ...
    r = ( 0UL != ( (*(ADC_1_UABH_B_INTR_MASKED_PTR)) & mask ) ) ? 1UL : 0UL;
    return r;
}

/*Power*/

/***************** ADC_1_UABH_B_SetUABPower() *****************************/
/*!
...
* 
* @internal
* @reglist @reg ADC_1_UABH_B_OA0_CTRL @reg ADC_1_UABH_B_OA1_CTRL
* @endinternal
* 
* @see ADC_1_UABH_B_Stop()
* @see ADC_1_UABH_B_SetOAPower()
...
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_OA_CTRL_PTR, 
      ADC_1_UABH_B_UAB_PWR_MASK, 
      ((uint32)powerLevel), 
      ADC_1_UABH_B_UAB_PWR_SHIFT
    );
}


/************* ADC_1_UABH_B_SetOAPower() **********************************/
/*!
...
void ADC_1_UABH_B_SetOAPower(CyUAB_fine_pwr_enum powerLevel)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_OA_CTRL_PTR, 
      ADC_1_UABH_B_OA_PWR_MASK, 
      ((uint32)powerLevel), 
      ADC_1_UABH_B_OA_PWR_SHIFT
    );
}


/******************** ADC_1_UABH_B_SetCompPower() *************************/
/*!
...
{  
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_OA_CTRL_PTR, 
      ADC_1_UABH_B_CMP_PWR_MASK, 
      ((uint32)powerLevel), 
      ADC_1_UABH_B_CMP_PWR_SHIFT
    );
}


/***************** ADC_1_UABH_B_SetRefPower *******************************/
/*!
...
* ADC_1_UABH_B_NET_REF signal--relative to the power mode of the UAB. Returns @c void.
* 
* @internal
* @reglist @reg ADC_1_UABH_B_OA0_CTRL @reg ADC_1_UABH_B_OA1_CTRL
...
void ADC_1_UABH_B_SetRefPower(CyUAB_fine_pwr_enum powerLevel)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_OA_CTRL_PTR, 
      ADC_1_UABH_B_REF_PWR_MASK, 
      ((uint32)powerLevel), 
      ADC_1_UABH_B_REF_PWR_SHIFT
    );
}


/**************** ADC_1_UABH_B_SetAgndPower() *****************************/
/*!
...
void ADC_1_UABH_B_SetAgndPower(CyUAB_fine_pwr_enum powerLevel)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_OA_CTRL_PTR, 
      ADC_1_UABH_B_AGND_PWR_MASK, 
      ((uint32)powerLevel), 
      ADC_1_UABH_B_AGND_PWR_SHIFT
    );
}


/**************** ADC_1_UABH_B_SetRefVdda() *******************************/
/*!
...
void ADC_1_UABH_B_SetRefVdda(CyUAB_ref_force_vdda_enum forceVdda)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_OA_CTRL_PTR, 
      ADC_1_UABH_B_REF_PTS_MASK, 
      ((uint32)forceVdda), 
      ADC_1_UABH_B_REF_PTS_SHIFT
    );
}


/*************** ADC_1_UABH_B_SetAgndVdda() *******************************/
/*!
...
void ADC_1_UABH_B_SetAgndVdda(CyUAB_agnd_force_vdda_enum forceVdda)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_OA_CTRL_PTR, 
      ADC_1_UABH_B_AGND_PTS_MASK, 
      ((uint32)forceVdda), 
      ADC_1_UABH_B_AGND_PTS_SHIFT
    );
}


/************* ADC_1_UABH_B_SetRefTied() **********************************/
/*!
...
*
* @internal
* @reglist @reg ADC_1_UABH_B_OA1_CTRL
* @image html _.png 
* @endinternal
* 
* 
* @see ADC_1_UABH_B_SetAgndTied()
* 
* @sideeffect None
*******************************************************************************/
...
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_REF_TIED_PTR, 
      ADC_1_UABH_B_REF_TIED_MASK, 
      ((uint32)refTied), 
      ADC_1_UABH_B_REF_TIED_SHIFT
    );
}

/*********** ADC_1_UABH_B_SetAgndTied() ***********************************/
/*!
...
* 
* @internal
* @reglist @reg ADC_1_UABH_B_OA0_CTRL
* @image html _.png 
* @endinternal
* 
* @see ADC_1_UABH_B_SetRefTied()
* 
* @sideeffect None
*******************************************************************************/
...
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_AGND_TIED_PTR, 
      ADC_1_UABH_B_AGND_TIED_MASK, 
      ((uint32)agndTied), 
      ADC_1_UABH_B_AGND_TIED_SHIFT
    );
}
...
* @see ADC_1_UABH_B_SetAttenBypassSwitchB()
* @see ADC_1_UABH_B_SetAttenBypassSwitchC()
*
* @see ADC_1_UABH_B_SetCaps()
* @see ADC_1_UABH_B_SetCapB()
* @see ADC_1_UABH_B_SetCapC()
* @see ADC_1_UABH_B_SetCapF()
*
* @internal
* @reglist @reg ADC_1_UABH_B_CAP_ABCF0_VAL @reg ADC_1_UABH_B_CAP_ABCF1_VAL
...
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_CAP_ABCF_VAL_PTR,
      ADC_1_UABH_B_CA_VAL_MASK, 
      ((uint32)capA), 
      ADC_1_UABH_B_CA_VAL_SHIFT
    );
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_CAP_AB_VAL_NXT_PTR, 
      ADC_1_UABH_B_CA_VAL_MASK, 
      ((uint32)capA), 
      ADC_1_UABH_B_CA_VAL_SHIFT
    ); 
...
*
* @see ADC_1_UABH_B_SetCaps()
* @see ADC_1_UABH_B_SetCapA()
* @see ADC_1_UABH_B_SetCapC()
* @see ADC_1_UABH_B_SetCapF()
* @see ADC_1_UABH_B_SetGroundUnused()
*
* @internal
* @reglist @reg ADC_1_UABH_B_CAP_ABCF0_VAL @reg ADC_1_UABH_B_CAP_ABCF1_VAL
* @image html SetCapacitors.png 
...
void ADC_1_UABH_B_SetCapB(CyUAB_b_cap_enum capB)
{
    ...
    const uint32 b64 = ADC_1_UABH_B_CB_64_MASK | ADC_1_UABH_B_CB_VAL_MASK;
    uint32 bval = (((uint32)capB)>=threshold64) ? b64 : ((uint32)capB);
    ADC_1_UABH_B_SET_VARIOUS_FIELDS(
      ADC_1_UABH_B_CAP_ABCF_VAL_PTR,
      ADC_1_UABH_B_CB_64_MASK | ADC_1_UABH_B_CB_VAL_MASK, 
       bval
    );
    ...
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_CAP_AB_VAL_NXT_PTR, 
      ADC_1_UABH_B_CB_VAL_MASK, 
      bval,
      ADC_1_UABH_B_CB_VAL_SHIFT
    );
}

/***************** ADC_1_UABH_B_SetCapC() *********************************/
/*!
...
void ADC_1_UABH_B_SetCapC(CyUAB_cap_enum capC)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_CAP_ABCF_VAL_PTR,
      ADC_1_UABH_B_CC_VAL_MASK, 
      ((uint32)capC), 
      ADC_1_UABH_B_CC_VAL_SHIFT
    );
    /*Not setting CC_VAL_UPDATE bit*/
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_CAP_CF_VAL_NXT_PTR, 
      ADC_1_UABH_B_CC_VAL_MASK, 
      ((uint32)capC), 
      ADC_1_UABH_B_CC_VAL_SHIFT
    );
...
void ADC_1_UABH_B_SetCapF(CyUAB_f_cap_enum capF)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_CAP_ABCF_VAL_PTR,
      ADC_1_UABH_B_CF_VAL_MASK, 
      ((uint32)capF), 
      ADC_1_UABH_B_CF_VAL_SHIFT
    );
...
* @note In branches B and C, there are attenuation capacitors in the signal path.
* This function does not configure those capacitors.  See ADC_1_UABH_B_SetAttenuationTrim() 
* and ADC_1_UABH_B_SetAttenBypassSwitch().
* 
...
* @see ADC_1_UABH_B_SetCapF()
* @see ADC_1_UABH_B_SetGroundUnused()
* @see ADC_1_UABH_B_SetSwitch(CyUAB_SW_TB,clk)
* @see ADC_1_UABH_B_SetSwitch(CyUAB_SW_TC,clk)
* 
* @internal
* @reglist @reg ADC_1_UABH_B_CAP_ABCF0_VAL @reg ADC_1_UABH_B_CAP_ABCF1_VAL
* @image html _.png 
...
{
    ADC_1_UABH_B_SetCapA(capA);
    ADC_1_UABH_B_SetCapB(capB);
    ADC_1_UABH_B_SetCapC(capC);
    ADC_1_UABH_B_SetCapF(capF);
}

/********* ADC_1_UABH_B_SetGroundUnused() *********************************/
/*!
...
*
* @internal
* @reglist @reg ADC_1_UABH_B_CAP_CTRL0 ADC_1_UABH_B_CAP_CTRL1
* @image html SetCapacitors.png 
* @endinternal
*
* @sideeffect None
...
void ADC_1_UABH_B_SetGroundUnused(CyUAB_gnd_unused_enum gndUnusedB, CyUAB_gnd_unused_enum gndUnusedC )
{
    ...
    const uint32 CB_GND_PRESHIFT_MASK = ADC_1_UABH_B_CB_GND_MASK>>ADC_1_UABH_B_CB_GND_SHIFT;
    const uint32 CC_GND_PRESHIFT_MASK = ADC_1_UABH_B_CC_GND_MASK>>ADC_1_UABH_B_CC_GND_SHIFT;
    const uint32 mask = ADC_1_UABH_B_CC_GND_MASK | ADC_1_UABH_B_CB_GND_MASK;
    ADC_1_UABH_B_SET_VARIOUS_FIELDS(
      ADC_1_UABH_B_CAP_CTRL_PTR,
      mask,
      ((uint32)( 
        ( ( ((uint32)gndUnusedC) & CC_GND_PRESHIFT_MASK) <<ADC_1_UABH_B_CC_GND_SHIFT ) |
        ( ( ((uint32)gndUnusedB) & CB_GND_PRESHIFT_MASK) <<ADC_1_UABH_B_CB_GND_SHIFT )
      ))
    );
}
...
*
* @see ADC_1_UABH_B_SetDacMode()
* @see ADC_1_UABH_B_SetModbitSource()
*
* @internal
* @reglist @reg ADC_1_UABH_B_CAP_CTRL_REG
* @endinternal
* 
* @sideeffect None
*******************************************************************************/
void ADC_1_UABH_B_SetDacModeEn(CyUAB_dac_mode_en_enum isEnabled)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_CAP_CTRL_PTR, 
      ADC_1_UABH_B_DAC_MODE_EN_MASK, 
      ((uint32)isEnabled), 
      ADC_1_UABH_B_DAC_MODE_EN_SHIFT
    );
}

/*************** ADC_1_UABH_B_SetDacMode() ********************************/
/*!
...
void ADC_1_UABH_B_SetDacMode(CyUAB_dac_mode_enum dacMode)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_CAP_CTRL_PTR, 
      ADC_1_UABH_B_DAC_MODE_MASK, 
      ((uint32)dacMode), 
      ADC_1_UABH_B_DAC_MODE_SHIFT
    );    
}

/*************** ADC_1_UABH_B_SetDacNext() ********************************/
/*!
...
*
* @internal
* @reglist @reg ADC_1_UABH_B_CAP_AB_VAL_NXT_REG.
...
void ADC_1_UABH_B_SetDacNext(int16 nextDACVal)
{
    ...
    uint32 val = ( ((uint32)nextDACVal) & ((uint32)ADC_1_UABH_B_DAC_NEXT_MASK) );
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_CAP_AB_VAL_NXT_PTR, 
      ADC_1_UABH_B_DAC_NEXT_MASK, 
      val, 
      ADC_1_UABH_B_CB_VAL_SHIFT
    );
}
...
*
* @internal
* @reglist @reg ADC_1_UABH_B_CAP_CF_VAL_NXT_REG.
* This function is @b NOT generalized.  It depends on the 'next' values all
* being contiguous within a single register.
* @endinternal
* 
* @sideeffect None
*******************************************************************************/
void ADC_1_UABH_B_SetCapCFNext(CyUAB_cap_enum nextCapC,CyUAB_f_cap_enum nextCapF)
{
    const uint32 CF_VAL_PRESHIFT_MASK = ((uint32)(ADC_1_UABH_B_CF_VAL_MASK>>ADC_1_UABH_B_CF_VAL_SHIFT));
    const uint32 CC_VAL_PRESHIFT_MASK = ((uint32)(ADC_1_UABH_B_CC_VAL_MASK>>ADC_1_UABH_B_CC_VAL_SHIFT));
    const uint32 mask = ((uint32)ADC_1_UABH_B_CF_VAL_UPDATE_MASK) | ((uint32)ADC_1_UABH_B_CC_VAL_UPDATE_MASK) |
      ((uint32)ADC_1_UABH_B_CF_VAL_MASK) | ((uint32)ADC_1_UABH_B_CC_VAL_MASK);
    
    /* Also setting CF_VAL_UPDATE and CC_VAL_UPDATE bits */
    ADC_1_UABH_B_SET_VARIOUS_FIELDS(
      ADC_1_UABH_B_CAP_CF_VAL_NXT_PTR,
      mask,
      ((uint32)ADC_1_UABH_B_CF_VAL_UPDATE_MASK) | ((uint32)ADC_1_UABH_B_CC_VAL_UPDATE_MASK) |
        ( ( ((uint32)nextCapF) & CF_VAL_PRESHIFT_MASK)<<ADC_1_UABH_B_CF_VAL_SHIFT ) |
        ( ( ((uint32)nextCapC) & CC_VAL_PRESHIFT_MASK)<<ADC_1_UABH_B_CC_VAL_SHIFT ) 
	);
}
...
/*************** ADC_1_UABH_B_SetCompEdgeDetect() *************************/
/*!
...
*
* @internal
* @reglist @reg ADC_1_UABH_B_OA0_CTRL_REG ADC_1_UABH_B_OA1_CTRL_REG
* @endinternal
* 
* 
* @see ADC_1_UABH_B_SetCompOutLevel()
* @see ADC_1_UABH_B_GetCompStatus()
* 
* @sideeffect None
*******************************************************************************/
void ADC_1_UABH_B_SetCompEdgeDetect(CyUAB_cmp_edge_enum detectMode)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_OA_CTRL_PTR, 
      ADC_1_UABH_B_CMP_EDGE_MASK, 
      ((uint32)detectMode), 
      ADC_1_UABH_B_CMP_EDGE_SHIFT
    );
}

/************ ADC_1_UABH_B_SetCompOutLevel ********************************/
/*!
...
* 
* @internal
* @reglist @reg ADC_1_UABH_B_OA0_CTRL_REG
* @endinternal
* 
* @param isLevel
...
*
* @see ADC_1_UABH_B_SetCompEdgeDetect()
* 
* @see ADC_1_UABH_B_GetCompStatus()
* 
* @sideeffect None
...
void ADC_1_UABH_B_SetCompOutLevel(CyUAB_cmp_level_enum isLevel)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_OA_CTRL_PTR, 
      ADC_1_UABH_B_CMP_DSI_LEVEL_MASK, 
      ((uint32)isLevel), 
      ADC_1_UABH_B_CMP_DSI_LEVEL_SHIFT
    );
}


/************  ADC_1_UABH_B_GetCompStatus() *******************************/
/*!
...
uint32 ADC_1_UABH_B_GetCompStatus(void)
{
    ...
    uint32 r = (0UL != ((*(ADC_1_UABH_B_STAT_PTR)) & ADC_1_UABH_B_COMP_MASK)) ? 1UL : 0UL;
    return r;    
}
...
*
* @internal
* @reglist @reg ADC_1_UABH_B_SW_STATIC0_REG or ADC_1_UABH_B_SW_STATIC1_REG
* @image html _.png 
* @endinternal
* 
* @sideeffect None
...
void ADC_1_UABH_B_SetEarly(CyUAB_sw_id_enum sw_id, CyUAB_clk_adj_enum isEarly)
{
    ...
    {
        ADC_1_UABH_B_SET_FIELD(
          ADC_1_UABH_B_SW_STATIC_PTR, 
          ADC_1_UABH_B_EARLY_PS_MASK, 
          ((uint32)isEarly), 
          ADC_1_UABH_B_EARLY_PS_SHIFT
        ); 
    }
    else if( CyUAB_SW_PO==sw_id )
    {
        ADC_1_UABH_B_SET_FIELD(
          ADC_1_UABH_B_SW_STATIC_PTR, 
          ADC_1_UABH_B_EARLY_PO_MASK, 
          ((uint32)isEarly), 
          ADC_1_UABH_B_EARLY_PO_SHIFT
        );
    }
    else
    {
...
* they will either wait for a trigger (see ADC_1_UABH_B_SetInputTrigger()),
...
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_SRAM_CTRL_PTR,
      ADC_1_UABH_B_RUN_MASK, 
      flag, 
      ADC_1_UABH_B_RUN_SHIFT
    );    
}


/************** ADC_1_UABH_B_SetLastStep() ********************************/
/*!
...
* 
* @internal
* @reglist @reg ADC_1_UABH_B_SRAM0_CTRL_REG
* @endinternal
* 
...
void ADC_1_UABH_B_SetLastStep(uint32 lastStep)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_SRAM_CTRL_PTR, 
      ADC_1_UABH_B_LAST_STEP_MASK,
      lastStep, 
      ADC_1_UABH_B_LAST_STEP_SHIFT
    );    
}

/******** ADC_1_UABH_B_SetStartupDelay() **********************************/
/*!
...
* 
* @internal
* @reglist @reg ADC_1_UABH_B_STARTUP_DELAY0_REG
* @endinternal
* 
...
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_STARTUP_DELAY_PTR, 
      ADC_1_UABH_B_STARTUP_DELAY_MASK, 
      (uint32)delayCount, 
      ADC_1_UABH_B_STARTUP_DELAY_SHIFT
    );
}

/*********** ADC_1_UABH_B_SetAlignMode() **********************************/
/*!
...
*
* @internal
* @reglist @reg ADC_1_UABH_B_STARTUP_DELAY0_REG , ADC_1_UABH_B_STARTUP_DELAY1_REG
* @endinternal
*
* 
* @sideeffect None
...
void ADC_1_UABH_B_SetAlignMode(CyUAB_align_mode_enum alignMode)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_STARTUP_DELAY_PTR, 
      ADC_1_UABH_B_ALIGN_MODE_MASK, 
      ((uint32)alignMode), 
      ADC_1_UABH_B_ALIGN_MODE_SHIFT
    );
}


/******** ADC_1_UABH_B_SetSubsample() *************************************/
/*!
...
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_SUBSAMPLE_CTRL_PTR, 
      ADC_1_UABH_B_SUBSAMPLE_MASK, 
      ((uint32)subsample), 
      ADC_1_UABH_B_SUBSAMPLE_SHIFT
    );
}

/***************  ADC_1_UABH_B_SetSubsampleInit() *************************/
/*!
...
void ADC_1_UABH_B_SetSubsampleInit(uint8 subsampleInit)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_SUBSAMPLE_CTRL_PTR, 
      ADC_1_UABH_B_SUBSAMPLE_INIT_MASK, 
      ((uint32)subsampleInit), 
      ADC_1_UABH_B_SUBSAMPLE_INIT_SHIFT
    );
}


/************* ADC_1_UABH_B_GetCurrentSubsample() *************************/
/*!
...
{
    return ADC_1_UABH_B_GET_FIELD(
      ADC_1_UABH_B_STAT_PTR,
      ADC_1_UABH_B_CURR_SUBSAMPLE_MASK,
      ADC_1_UABH_B_CURR_SUBSAMPLE_SHIFT
    );
}

/************** ADC_1_UABH_B_GetCurrentStep() *****************************/
/*!
* @brief Get currStep
* 
* @details
...
uint32 ADC_1_UABH_B_GetCurrentStep(void)
{
    return ADC_1_UABH_B_GET_FIELD(
      ADC_1_UABH_B_STAT_PTR,
      ADC_1_UABH_B_CURR_STEP_MASK,
      ADC_1_UABH_B_CURR_STEP_SHIFT
    );
}


/**************** ADC_1_UABH_B_SetModbitSource() **************************/
/*!
...
* 
* @internal
* @reglist @reg ADC_1_UABH_B_SW_MODBIT_SRC0 , ADC_1_UABH_B_SW_MODBIT_SRC1
* @endinternal
* 
...
{
    /*mask input values before shifting to prevent overlap*/
    const uint32 MODBIT_SRC_AB_PRESHIFT_MASK = ADC_1_UABH_B_MODBIT0_SRC_SEL_MASK>>ADC_1_UABH_B_MODBIT0_SRC_SEL_SHIFT;
    const uint32 MODBIT_SRC_C_PRESHIFT_MASK = ADC_1_UABH_B_MODBIT1_SRC_SEL_MASK>>ADC_1_UABH_B_MODBIT1_SRC_SEL_SHIFT;
    ADC_1_UABH_B_SET_VARIOUS_FIELDS(
      ADC_1_UABH_B_SW_MODBIT_SRC_PTR,
      ADC_1_UABH_B_MODBIT1_SRC_SEL_MASK | ADC_1_UABH_B_MODBIT0_SRC_SEL_MASK,
      (uint32)( 
        ( (modbitSrcAB & MODBIT_SRC_AB_PRESHIFT_MASK) <<ADC_1_UABH_B_MODBIT0_SRC_SEL_SHIFT ) | 
        ( (modbitSrcC &MODBIT_SRC_C_PRESHIFT_MASK) <<ADC_1_UABH_B_MODBIT1_SRC_SEL_SHIFT ) 
      )
    );    
}


/********************** ADC_1_UABH_B_SetStrobeMode ************************/
/*!
...
void ADC_1_UABH_B_SetStrobeMode(CyUAB_strobe_mode_enum strobeMode)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_SW_STATIC_PTR, 
      ADC_1_UABH_B_STRB_RST_EN_MASK, 
      ((uint32)strobeMode), 
      ADC_1_UABH_B_STRB_RST_EN_SHIFT
    );
}

/*********** ADC_1_UABH_B_SetStrobeSource *********************************/
/*!
...
@internal
@reglist @reg ADC_1_UABH_B_SW_STATIC0_REG.STRB_RST0_SEL or ADC_1_UABH_B_SW_STATIC1_REG.STRB_RST1_SEL
@endinternal
...
void ADC_1_UABH_B_SetStrobeSource(uint32 strobeSource)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_SW_STATIC_PTR, 
      ADC_1_UABH_B_STRB_RST_SEL_MASK, 
      strobeSource, 
      ADC_1_UABH_B_STRB_RST_SEL_SHIFT
    );
}


/************ ADC_1_UABH_B_SetFirmwareModbit() ****************************/
/*!
* @brief Set the firmware modbit.
* 
* @details This function sets the firmware modbit. The modbit affects several 
* clocks.  If firmware modbit is selected (Use ADC_1_UABH_B_SetModbitSource() choice 31),
...
void ADC_1_UABH_B_SetFirmwareModbit(uint32 flag)
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_CAP_ABCF_VAL_PTR, 
      ADC_1_UABH_B_SIGN_VAL_MASK,
      (uint32)flag, 
      ADC_1_UABH_B_SIGN_VAL_SHIFT
    );
}


/************* ADC_1_UABH_B_SetInputTrigger() *****************************/
/*!
...
* which trigger to use.  Trigger state is irrelevant if ADC_1_UABH_B_EnableClocks()
* has not been called.
* 
* @internal
* @reglist @reg ADC_1_UABH_B_SRAM0_CTRL_REG ADC_1_UABH_B_SRAM1_CTRL_REG
* @endinternal
* 
* @param triggerEn Enables the input trigger.  If 0, trigger signal is ignored,
* and the SRAM clocks will start running as soon as the ADC_1_UABH_B_EnableClocks()
...
{
    /*mask input values before shifting to prevent overlap*/
    const uint32 TRIG_SEL_PRESHIFT_MASK = ADC_1_UABH_B_TRIG_SEL_MASK>>ADC_1_UABH_B_TRIG_SEL_SHIFT;
    const uint32 TRIGGER_EN_PRESHIFT_MASK = ADC_1_UABH_B_TRIGGER_EN_MASK>>ADC_1_UABH_B_TRIGGER_EN_SHIFT;
    ADC_1_UABH_B_SET_VARIOUS_FIELDS(
      ADC_1_UABH_B_SRAM_CTRL_PTR,
      ADC_1_UABH_B_TRIG_SEL_MASK | ADC_1_UABH_B_TRIGGER_EN_MASK,
      ( (triggerSel & TRIG_SEL_PRESHIFT_MASK) <<ADC_1_UABH_B_TRIG_SEL_SHIFT   ) | 
      ( (triggerEn & TRIGGER_EN_PRESHIFT_MASK) <<ADC_1_UABH_B_TRIGGER_EN_SHIFT )
    );
}


/****************** ADC_1_UABH_B_SetStaticSwitch() ************************/
/*!
...
{   
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_GetStaticSwAddr( (sw_id) ), 
      ADC_1_UABH_B_StaticSwMask( (sw_id) ),
      CyUAB_SwIsClosed( (clk) ), 
      ADC_1_UABH_B_StaticSwShift( (sw_id) )
    );
}


/******************** ADC_1_UABH_B_SetSwitch() ****************************/
/*!
...
{
    ADC_1_UABH_B_SET_FIELD(
      ADC_1_UABH_B_GetDynamicSwAddr( (sw_id) ),
      ADC_1_UABH_B_DynamicSwMask( (sw_id) ),
      ((uint32)((clk))), 
      ADC_1_UABH_B_DynamicSwShift( (sw_id) )
    ); 
}
