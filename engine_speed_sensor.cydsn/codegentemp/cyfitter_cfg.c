...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_CLK_SELECT), 0x00000020u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTB0_OA0_SW, 0x00040090u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTB0_CTBBUS_SW, 0x00200000u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTB1_CTB_CTRL, 0x80000000u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTB1_OA0_SW, 0x22800004u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTB1_OA1_SW, 0x01080080u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTB1_CTBBUS_SW, 0x00000200u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_ART_CTRL, 0x80000000u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_ART_SARMUXVMINUS_SW, 0x02000004u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_ART_SARMUXCOREIO0_SW, 0x01000001u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_ART_UAB0VIN03_SW, 0x40000000u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_ART_UAB0VIN10_SW, 0x80000000u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_ART_CTB0VREF_SW, 0x00000008u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_ART_UAB0VREF_SW, 0x08000008u);
...
/*******************************************************************************
* Function Name: engine_sensor_adc_filterVinMux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void engine_sensor_adc_filterVinMux_Set(uint8 channel)
{
	switch (channel) {
		case 0u:
...
/*******************************************************************************
* Function Name: engine_sensor_adc_filterVinMux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void engine_sensor_adc_filterVinMux_Unset(uint8 channel)
{
	switch (channel) {
		case 0u:
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_PERI_TR_GROUP0_TR_OUT_CTL0), 0x00000027u);
	...
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_GPIO_PRT0_PC), 0x00031036u);
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_GPIO_PRT0_PC2), 0x00000020u);

	/* IOPINS0_1 Starting address: CYDEV_GPIO_PRT1_BASE */
	CY_SET_XTND_REG32((void CYFAR *)(CYDEV_GPIO_PRT1_BASE), 0x0000000Du);
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_GPIO_PRT1_PC2), 0x0000000Du);
