/***************************************************************************//**
* \file engine_sensor_uart_UART_BOOT.c
* \version 3.20
*
* \brief
...
/*******************************************************************************
* Function Name: engine_sensor_uart_UartCyBtldrCommStart
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: engine_sensor_uart_UartCyBtldrCommStop
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: engine_sensor_uart_UartCyBtldrCommReset
****************************************************************************//**
*
...
void engine_sensor_uart_UartCyBtldrCommReset(void)
{
    ...
    engine_sensor_uart_SpiUartClearRxBuffer();
    engine_sensor_uart_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: engine_sensor_uart_UartCyBtldrCommRead
****************************************************************************//**
*
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != engine_sensor_uart_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = engine_sensor_uart_SpiUartGetRxBufferSize();
                    CyDelayUs(engine_sensor_uart_UART_BYTE_TO_BYTE);
                }
                while (byteCount != engine_sensor_uart_SpiUartGetRxBufferSize());

                byteCount = engine_sensor_uart_BYTES_TO_COPY(byteCount, size);
            ...
            CyDelay(engine_sensor_uart_WAIT_1_MS);
            --timeoutMs;
        }
        while (0u != timeoutMs);
        ...
        {
            pData[i] = (uint8) engine_sensor_uart_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: engine_sensor_uart_UartCyBtldrCommWrite
****************************************************************************//**
*
...
cystatus engine_sensor_uart_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        engine_sensor_uart_SpiUartPutArray(pData, (uint32) size);
