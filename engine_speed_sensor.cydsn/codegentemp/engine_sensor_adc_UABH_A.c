/*!*****************************************************************************
* \file engine_sensor_adc_UABH_A.c
* \version 1.10
*
* \brief 
...
uint32 engine_sensor_adc_UABH_A_initVar = 0UL; /**< 0 if component is uninitialized. 1 otherwise. */
...
/*! Part of default configuration used to initialize UAB in engine_sensor_adc_UABH_A_Start() */
uint16 engine_sensor_adc_UABH_A_waveConfig[engine_sensor_adc_UABH_A_NUM_STEPS] = {
/*0<=last_step<=15 , so always at least one step*/
((uint16)engine_sensor_adc_UABH_A_PARAM_WAVE_STEP_0)

#if engine_sensor_adc_UABH_A_INC_STEP_1
,((uint16)engine_sensor_adc_UABH_A_PARAM_WAVE_STEP_1)
#endif
#if engine_sensor_adc_UABH_A_INC_STEP_2
,((uint16)engine_sensor_adc_UABH_A_PARAM_WAVE_STEP_2)
#endif
#if engine_sensor_adc_UABH_A_INC_STEP_3
,((uint16)engine_sensor_adc_UABH_A_PARAM_WAVE_STEP_3)
#endif
#if engine_sensor_adc_UABH_A_INC_STEP_4
,((uint16)engine_sensor_adc_UABH_A_PARAM_WAVE_STEP_4)
#endif
#if engine_sensor_adc_UABH_A_INC_STEP_5
,((uint16)engine_sensor_adc_UABH_A_PARAM_WAVE_STEP_5)
#endif
#if engine_sensor_adc_UABH_A_INC_STEP_6
,((uint16)engine_sensor_adc_UABH_A_PARAM_WAVE_STEP_6)
#endif
#if engine_sensor_adc_UABH_A_INC_STEP_7
,((uint16)engine_sensor_adc_UABH_A_PARAM_WAVE_STEP_7)
#endif
#if engine_sensor_adc_UABH_A_INC_STEP_8
,((uint16)engine_sensor_adc_UABH_A_PARAM_WAVE_STEP_8)
#endif
#if engine_sensor_adc_UABH_A_INC_STEP_9
,((uint16)engine_sensor_adc_UABH_A_PARAM_WAVE_STEP_9)
#endif
#if engine_sensor_adc_UABH_A_INC_STEP_10
,((uint16)engine_sensor_adc_UABH_A_PARAM_WAVE_STEP_10)
#endif
#if engine_sensor_adc_UABH_A_INC_STEP_11
,((uint16)engine_sensor_adc_UABH_A_PARAM_WAVE_STEP_11)
#endif
#if engine_sensor_adc_UABH_A_INC_STEP_12
,((uint16)engine_sensor_adc_UABH_A_PARAM_WAVE_STEP_12)
#endif
#if engine_sensor_adc_UABH_A_INC_STEP_13
,((uint16)engine_sensor_adc_UABH_A_PARAM_WAVE_STEP_13)
#endif
#if engine_sensor_adc_UABH_A_INC_STEP_14
,((uint16)engine_sensor_adc_UABH_A_PARAM_WAVE_STEP_14)
#endif
#if engine_sensor_adc_UABH_A_INC_STEP_15
,((uint16)engine_sensor_adc_UABH_A_PARAM_WAVE_STEP_15)
#endif
};

/*! Part of default configuration used to initialize UAB in engine_sensor_adc_UABH_A_Start() */
CyUAB_reg_pair engine_sensor_adc_UABH_A_initPairs[engine_sensor_adc_UABH_A_INIT_PAIRS_COUNT] = {

	/*OA_CTRL default always first element in initPairs*/
#if engine_sensor_adc_UABH_A_NONZERO_OA_CTRL
    {engine_sensor_adc_UABH_A_OA_CTRL_PTR         , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_OA_CTRL)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_SW_STATIC
    ,{engine_sensor_adc_UABH_A_SW_STATIC_PTR      , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_SW_STATIC)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_SW_MODBIT_SRC
    ,{engine_sensor_adc_UABH_A_SW_MODBIT_SRC_PTR  , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_SW_MODBIT_SRC)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_SRAM_CTRL
    ,{engine_sensor_adc_UABH_A_SRAM_CTRL_PTR      , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_SRAM_CTRL)} 
#endif
...
#if engine_sensor_adc_UABH_A_NONZERO_INTR_MASK	
    ,{engine_sensor_adc_UABH_A_INTR_MASK_PTR      , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_INTR_MASK)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_CAP_CTRL
    ,{engine_sensor_adc_UABH_A_CAP_CTRL_PTR       , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_CAP_CTRL)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_CAP_ABCF_VAL
    ,{engine_sensor_adc_UABH_A_CAP_ABCF_VAL_PTR   , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_CAP_ABCF_VAL)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_CAP_AB_VAL_NXT
    ,{engine_sensor_adc_UABH_A_CAP_AB_VAL_NXT_PTR , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_CAP_AB_VAL_NXT)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_CAP_CF_VAL_NXT
    ,{engine_sensor_adc_UABH_A_CAP_CF_VAL_NXT_PTR , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_CAP_CF_VAL_NXT)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_STARTUP_DELAY
    ,{engine_sensor_adc_UABH_A_STARTUP_DELAY_PTR  , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_STARTUP_DELAY)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_SUBSAMPLE_CTRL
    ,{engine_sensor_adc_UABH_A_SUBSAMPLE_CTRL_PTR , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_SUBSAMPLE_CTRL)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_SW_CA_IN0
    ,{engine_sensor_adc_UABH_A_SW_CA_IN0_PTR      , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_SW_CA_IN0)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_SW_CA_IN1
    ,{engine_sensor_adc_UABH_A_SW_CA_IN1_PTR      , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_SW_CA_IN1)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_SW_CA_TOP
    ,{engine_sensor_adc_UABH_A_SW_CA_TOP_PTR      , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_SW_CA_TOP)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_SW_CB_IN0
    ,{engine_sensor_adc_UABH_A_SW_CB_IN0_PTR      , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_SW_CB_IN0)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_SW_CB_IN1
    ,{engine_sensor_adc_UABH_A_SW_CB_IN1_PTR      , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_SW_CB_IN1)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_SW_CB_TOP
    ,{engine_sensor_adc_UABH_A_SW_CB_TOP_PTR      , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_SW_CB_TOP)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_SW_CC_IN0
    ,{engine_sensor_adc_UABH_A_SW_CC_IN0_PTR      , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_SW_CC_IN0)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_SW_CC_IN1
    ,{engine_sensor_adc_UABH_A_SW_CC_IN1_PTR      , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_SW_CC_IN1)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_SW_CC_TOP
    ,{engine_sensor_adc_UABH_A_SW_CC_TOP_PTR      , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_SW_CC_TOP)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_SW_CF_BOT
    ,{engine_sensor_adc_UABH_A_SW_CF_BOT_PTR      , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_SW_CF_BOT)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_SW_OTHER
    ,{engine_sensor_adc_UABH_A_SW_OTHER_PTR       , ((uint32)engine_sensor_adc_UABH_A_DEFAULT_SW_OTHER)}
#endif
#if engine_sensor_adc_UABH_A_NONZERO_SW_BOOST_CTRL
...
/*! Default configuration used to initialize UAB in engine_sensor_adc_UABH_A_Start() */
CyUAB_config engine_sensor_adc_UABH_A_config = {
    engine_sensor_adc_UABH_A_waveConfig,
    engine_sensor_adc_UABH_A_initPairs,
    ...
    (uint8)(engine_sensor_adc_UABH_A_ELEMENT_COUNT(engine_sensor_adc_UABH_A_initPairs))
};

/*! @} group_init */


/************** engine_sensor_adc_UABH_A_Start() **************************************/
/*!
* @brief Initializes and enables the component.
* 
* @details This function is equivalent to calling 
* engine_sensor_adc_UABH_A_Enable(), engine_sensor_adc_UABH_A_Init(&engine_sensor_adc_UABH_A_config), and engine_sensor_adc_UABH_A_Run(1UL).  
...
* @endinternal
* 
* @see engine_sensor_adc_UABH_A_Enable()
* @see engine_sensor_adc_UABH_A_Init()
* @see engine_sensor_adc_UABH_A_Run()
* @see engine_sensor_adc_UABH_A_Stop()
*
* @sideeffect Sets ENABLED bit for whole UAB - both half0 and half1.
*
* \globalvars
*  \ref engine_sensor_adc_UABH_A_initVar (RW)
*
*******************************************************************************/
void engine_sensor_adc_UABH_A_Start(void)
{
    if (engine_sensor_adc_UABH_A_initVar != 1UL)
    {
        engine_sensor_adc_UABH_A_Init(&engine_sensor_adc_UABH_A_config);
        engine_sensor_adc_UABH_A_initVar = 1UL;
    }
    else 
    {
    ...
    engine_sensor_adc_UABH_A_Run(1UL); /*set the run bit*/
}
...
* @endinternal
* 
* @see engine_sensor_adc_UABH_A_Start()
* @see engine_sensor_adc_UABH_A_Run()
* 
* @sideeffect None
*******************************************************************************/
...
{
    engine_sensor_adc_UABH_A_Run(0UL); /*Clear run bit*/
...
{
#if engine_sensor_adc_UABH_A_ISPAIRED 
    ...
    CyUAB_SetNSteps( engine_sensor_adc_UABH_A_SRAM0_PTR, ((size_t)(cfg->stepCount)), (cfg->waveSteps) );
    
    /* Optimized version of ClearAllClocks() -- 
    Clear remaining wavesteps, so clock editing with SetClock() works
    */
    (void)CyUAB_wordset( 
        ((reg32*)( ((uint32)(engine_sensor_adc_UABH_A_SRAM0_PTR)) + (((uint32)(cfg->stepCount))*sizeof(uint32)) )), 
        0UL, 
        ( ( CyUAB_STEPS_LEN_MAX - ((uint32)(cfg->stepCount)) ) * sizeof(uint32) )
    );
    
    engine_sensor_adc_UABH_A_WriteInitPairs( cfg->pairs, ((size_t)(cfg->pairCount)) );
    /* ^ 
    *  | 
    *  | 
    *  Direct writes must happen before writing shared switch fields*/
    ...
    engine_sensor_adc_UABH_A_SetAgndTied( agndTied );
    refTied = CyUAB_SHARED_SW_CFG_REFTIED(  cfg->shared_sw );
    engine_sensor_adc_UABH_A_SetRefTied( refTied );
    clk_AA = CyUAB_SHARED_SW_CFG_AA(  cfg->shared_sw );
    engine_sensor_adc_UABH_A_SetSwitch( CyUAB_SW_AA, clk_AA );
    clk_BB = CyUAB_SHARED_SW_CFG_BB(  cfg->shared_sw );
    engine_sensor_adc_UABH_A_SetSwitch( CyUAB_SW_BB, clk_BB );
    clk_CC = CyUAB_SHARED_SW_CFG_CC(  cfg->shared_sw );
    engine_sensor_adc_UABH_A_SetSwitch( CyUAB_SW_CC, clk_CC );
#endif
...
* How to disable:
* engine_sensor_adc_UABH_A_UAB_CTRL_REG &= ~engine_sensor_adc_UABH_A_ENABLED_MASK;
*
...
{
    engine_sensor_adc_UABH_A_UAB_CTRL_REG |= engine_sensor_adc_UABH_A_ENABLED_MASK; /*Side effect: also enables other UAB half in same pair*/
}
...
/*********** engine_sensor_adc_UABH_A_ClearInterrupt() ********************************/
/*!
...
*
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_INTR_REG
* @endinternal
* 
* @see engine_sensor_adc_UABH_A_SetInterrupt()
* 
* @see engine_sensor_adc_UABH_A_SetInterruptMask()
* @see engine_sensor_adc_UABH_A_ClearInterruptMask()
* @see engine_sensor_adc_UABH_A_GetInterruptIsMasked()
* 
* @sideeffect None
*******************************************************************************/
void engine_sensor_adc_UABH_A_ClearInterrupt(CyUAB_intr_enum intr)
{
    ...
    uint32 mask = ( (CyUAB_INTR_COMP==intr)      ? ((uint32)engine_sensor_adc_UABH_A_INTR_COMP_MASK) : 
                  ( (CyUAB_INTR_VDAC_EMPTY==intr)? ((uint32)engine_sensor_adc_UABH_A_INTR_VDAC_EMPTY_MASK) : 
                  0UL ) );
    if(0UL!=mask)
    {
        *(engine_sensor_adc_UABH_A_INTR_PTR) |= mask;    
    }
}

/************* engine_sensor_adc_UABH_A_SetInterrupt() ********************************/
/*!
...
*
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_INTR_SET_REG
* @endinternal
*
* 
* @see engine_sensor_adc_UABH_A_ClearInterrupt()
* @see engine_sensor_adc_UABH_A_SetInterruptMask()
* @see engine_sensor_adc_UABH_A_ClearInterruptMask()
* @see engine_sensor_adc_UABH_A_GetInterruptIsMasked()
* 
...
void engine_sensor_adc_UABH_A_SetInterrupt(CyUAB_intr_enum intr)
{
    ...
    if(0UL!=mask)
    {
        *(engine_sensor_adc_UABH_A_INTR_SET_PTR) |= mask;
    }
}

/************** engine_sensor_adc_UABH_A_SetInterruptMask() ***************************/
/*!
...
*
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_INTR_MASK_REG
* @endinternal
* 
* @see engine_sensor_adc_UABH_A_SetInterrupt()
* @see engine_sensor_adc_UABH_A_ClearInterrupt()
...
void engine_sensor_adc_UABH_A_SetInterruptMask(CyUAB_intr_enum intr)
{
    ...
    if(0UL!=mask)
    {
        *(engine_sensor_adc_UABH_A_INTR_MASK_PTR) |= mask;    
    }
}

/************* engine_sensor_adc_UABH_A_ClearInterruptMask() **************************/
/*!
...
/********** engine_sensor_adc_UABH_A_GetInterruptIsMasked() ***************************/
/*!
...
*
* @internal
* @reglist engine_sensor_adc_UABH_A_INTR_MASKED_REG
* @endinternal
*
* @see engine_sensor_adc_UABH_A_SetInterrupt()
* @see engine_sensor_adc_UABH_A_ClearInterrupt()
...
uint32 engine_sensor_adc_UABH_A_GetInterruptIsMasked(CyUAB_intr_enum intr)
{
    ...
    r = ( 0UL != ( (*(engine_sensor_adc_UABH_A_INTR_MASKED_PTR)) & mask ) ) ? 1UL : 0UL;
    return r;
}

/*Power*/

/***************** engine_sensor_adc_UABH_A_SetUABPower() *****************************/
/*!
...
* 
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_OA0_CTRL @reg engine_sensor_adc_UABH_A_OA1_CTRL
* @endinternal
* 
* @see engine_sensor_adc_UABH_A_Stop()
* @see engine_sensor_adc_UABH_A_SetOAPower()
...
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_OA_CTRL_PTR, 
      engine_sensor_adc_UABH_A_UAB_PWR_MASK, 
      ((uint32)powerLevel), 
      engine_sensor_adc_UABH_A_UAB_PWR_SHIFT
    );
}


/************* engine_sensor_adc_UABH_A_SetOAPower() **********************************/
/*!
...
void engine_sensor_adc_UABH_A_SetOAPower(CyUAB_fine_pwr_enum powerLevel)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_OA_CTRL_PTR, 
      engine_sensor_adc_UABH_A_OA_PWR_MASK, 
      ((uint32)powerLevel), 
      engine_sensor_adc_UABH_A_OA_PWR_SHIFT
    );
}


/******************** engine_sensor_adc_UABH_A_SetCompPower() *************************/
/*!
...
{  
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_OA_CTRL_PTR, 
      engine_sensor_adc_UABH_A_CMP_PWR_MASK, 
      ((uint32)powerLevel), 
      engine_sensor_adc_UABH_A_CMP_PWR_SHIFT
    );
}


/***************** engine_sensor_adc_UABH_A_SetRefPower *******************************/
/*!
...
* engine_sensor_adc_UABH_A_NET_REF signal--relative to the power mode of the UAB. Returns @c void.
* 
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_OA0_CTRL @reg engine_sensor_adc_UABH_A_OA1_CTRL
...
void engine_sensor_adc_UABH_A_SetRefPower(CyUAB_fine_pwr_enum powerLevel)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_OA_CTRL_PTR, 
      engine_sensor_adc_UABH_A_REF_PWR_MASK, 
      ((uint32)powerLevel), 
      engine_sensor_adc_UABH_A_REF_PWR_SHIFT
    );
}


/**************** engine_sensor_adc_UABH_A_SetAgndPower() *****************************/
/*!
...
void engine_sensor_adc_UABH_A_SetAgndPower(CyUAB_fine_pwr_enum powerLevel)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_OA_CTRL_PTR, 
      engine_sensor_adc_UABH_A_AGND_PWR_MASK, 
      ((uint32)powerLevel), 
      engine_sensor_adc_UABH_A_AGND_PWR_SHIFT
    );
}


/**************** engine_sensor_adc_UABH_A_SetRefVdda() *******************************/
/*!
...
void engine_sensor_adc_UABH_A_SetRefVdda(CyUAB_ref_force_vdda_enum forceVdda)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_OA_CTRL_PTR, 
      engine_sensor_adc_UABH_A_REF_PTS_MASK, 
      ((uint32)forceVdda), 
      engine_sensor_adc_UABH_A_REF_PTS_SHIFT
    );
}


/*************** engine_sensor_adc_UABH_A_SetAgndVdda() *******************************/
/*!
...
void engine_sensor_adc_UABH_A_SetAgndVdda(CyUAB_agnd_force_vdda_enum forceVdda)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_OA_CTRL_PTR, 
      engine_sensor_adc_UABH_A_AGND_PTS_MASK, 
      ((uint32)forceVdda), 
      engine_sensor_adc_UABH_A_AGND_PTS_SHIFT
    );
}


/************* engine_sensor_adc_UABH_A_SetRefTied() **********************************/
/*!
...
*
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_OA1_CTRL
* @image html _.png 
* @endinternal
* 
* 
* @see engine_sensor_adc_UABH_A_SetAgndTied()
* 
* @sideeffect None
*******************************************************************************/
...
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_REF_TIED_PTR, 
      engine_sensor_adc_UABH_A_REF_TIED_MASK, 
      ((uint32)refTied), 
      engine_sensor_adc_UABH_A_REF_TIED_SHIFT
    );
}

/*********** engine_sensor_adc_UABH_A_SetAgndTied() ***********************************/
/*!
...
* 
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_OA0_CTRL
* @image html _.png 
* @endinternal
* 
* @see engine_sensor_adc_UABH_A_SetRefTied()
* 
* @sideeffect None
*******************************************************************************/
...
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_AGND_TIED_PTR, 
      engine_sensor_adc_UABH_A_AGND_TIED_MASK, 
      ((uint32)agndTied), 
      engine_sensor_adc_UABH_A_AGND_TIED_SHIFT
    );
}
...
/***************** engine_sensor_adc_UABH_A_SetCapA() *********************************/
/*!
...
* @see engine_sensor_adc_UABH_A_SetAttenBypassSwitchB()
* @see engine_sensor_adc_UABH_A_SetAttenBypassSwitchC()
*
* @see engine_sensor_adc_UABH_A_SetCaps()
* @see engine_sensor_adc_UABH_A_SetCapB()
* @see engine_sensor_adc_UABH_A_SetCapC()
* @see engine_sensor_adc_UABH_A_SetCapF()
*
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_CAP_ABCF0_VAL @reg engine_sensor_adc_UABH_A_CAP_ABCF1_VAL
...
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_CAP_ABCF_VAL_PTR,
      engine_sensor_adc_UABH_A_CA_VAL_MASK, 
      ((uint32)capA), 
      engine_sensor_adc_UABH_A_CA_VAL_SHIFT
    );
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_CAP_AB_VAL_NXT_PTR, 
      engine_sensor_adc_UABH_A_CA_VAL_MASK, 
      ((uint32)capA), 
      engine_sensor_adc_UABH_A_CA_VAL_SHIFT
    ); 
...
/***************** engine_sensor_adc_UABH_A_SetCapB() *********************************/
/*!
...
void engine_sensor_adc_UABH_A_SetCapB(CyUAB_b_cap_enum capB)
{
    ...
    const uint32 b64 = engine_sensor_adc_UABH_A_CB_64_MASK | engine_sensor_adc_UABH_A_CB_VAL_MASK;
    uint32 bval = (((uint32)capB)>=threshold64) ? b64 : ((uint32)capB);
    engine_sensor_adc_UABH_A_SET_VARIOUS_FIELDS(
      engine_sensor_adc_UABH_A_CAP_ABCF_VAL_PTR,
      engine_sensor_adc_UABH_A_CB_64_MASK | engine_sensor_adc_UABH_A_CB_VAL_MASK, 
       bval
    );
    ...
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_CAP_AB_VAL_NXT_PTR, 
      engine_sensor_adc_UABH_A_CB_VAL_MASK, 
      bval,
      engine_sensor_adc_UABH_A_CB_VAL_SHIFT
    );
}

/***************** engine_sensor_adc_UABH_A_SetCapC() *********************************/
/*!
...
void engine_sensor_adc_UABH_A_SetCapC(CyUAB_cap_enum capC)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_CAP_ABCF_VAL_PTR,
      engine_sensor_adc_UABH_A_CC_VAL_MASK, 
      ((uint32)capC), 
      engine_sensor_adc_UABH_A_CC_VAL_SHIFT
    );
    /*Not setting CC_VAL_UPDATE bit*/
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_CAP_CF_VAL_NXT_PTR, 
      engine_sensor_adc_UABH_A_CC_VAL_MASK, 
      ((uint32)capC), 
      engine_sensor_adc_UABH_A_CC_VAL_SHIFT
    );
...
/***************** engine_sensor_adc_UABH_A_SetCapF() *********************************/
/*!
...
void engine_sensor_adc_UABH_A_SetCapF(CyUAB_f_cap_enum capF)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_CAP_ABCF_VAL_PTR,
      engine_sensor_adc_UABH_A_CF_VAL_MASK, 
      ((uint32)capF), 
      engine_sensor_adc_UABH_A_CF_VAL_SHIFT
    );
...
/***************** engine_sensor_adc_UABH_A_SetCaps() *********************************/
/*!
...
* @note In branches B and C, there are attenuation capacitors in the signal path.
* This function does not configure those capacitors.  See engine_sensor_adc_UABH_A_SetAttenuationTrim() 
* and engine_sensor_adc_UABH_A_SetAttenBypassSwitch().
* 
...
* @see engine_sensor_adc_UABH_A_SetCapF()
* @see engine_sensor_adc_UABH_A_SetGroundUnused()
* @see engine_sensor_adc_UABH_A_SetSwitch(CyUAB_SW_TB,clk)
* @see engine_sensor_adc_UABH_A_SetSwitch(CyUAB_SW_TC,clk)
* 
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_CAP_ABCF0_VAL @reg engine_sensor_adc_UABH_A_CAP_ABCF1_VAL
* @image html _.png 
...
{
    engine_sensor_adc_UABH_A_SetCapA(capA);
    engine_sensor_adc_UABH_A_SetCapB(capB);
    engine_sensor_adc_UABH_A_SetCapC(capC);
    engine_sensor_adc_UABH_A_SetCapF(capF);
}

/********* engine_sensor_adc_UABH_A_SetGroundUnused() *********************************/
/*!
...
*
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_CAP_CTRL0 engine_sensor_adc_UABH_A_CAP_CTRL1
* @image html SetCapacitors.png 
* @endinternal
*
* @sideeffect None
...
void engine_sensor_adc_UABH_A_SetGroundUnused(CyUAB_gnd_unused_enum gndUnusedB, CyUAB_gnd_unused_enum gndUnusedC )
{
    ...
    const uint32 CB_GND_PRESHIFT_MASK = engine_sensor_adc_UABH_A_CB_GND_MASK>>engine_sensor_adc_UABH_A_CB_GND_SHIFT;
    const uint32 CC_GND_PRESHIFT_MASK = engine_sensor_adc_UABH_A_CC_GND_MASK>>engine_sensor_adc_UABH_A_CC_GND_SHIFT;
    const uint32 mask = engine_sensor_adc_UABH_A_CC_GND_MASK | engine_sensor_adc_UABH_A_CB_GND_MASK;
    engine_sensor_adc_UABH_A_SET_VARIOUS_FIELDS(
      engine_sensor_adc_UABH_A_CAP_CTRL_PTR,
      mask,
      ((uint32)( 
        ( ( ((uint32)gndUnusedC) & CC_GND_PRESHIFT_MASK) <<engine_sensor_adc_UABH_A_CC_GND_SHIFT ) |
        ( ( ((uint32)gndUnusedB) & CB_GND_PRESHIFT_MASK) <<engine_sensor_adc_UABH_A_CB_GND_SHIFT )
      ))
    );
}
...
/******************* engine_sensor_adc_UABH_A_SetDacModeEn() **************************/
/*!
...
* @see engine_sensor_adc_UABH_A_SetModbitSource()
*
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_CAP_CTRL_REG
* @endinternal
* 
* @sideeffect None
*******************************************************************************/
void engine_sensor_adc_UABH_A_SetDacModeEn(CyUAB_dac_mode_en_enum isEnabled)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_CAP_CTRL_PTR, 
      engine_sensor_adc_UABH_A_DAC_MODE_EN_MASK, 
      ((uint32)isEnabled), 
      engine_sensor_adc_UABH_A_DAC_MODE_EN_SHIFT
    );
}

/*************** engine_sensor_adc_UABH_A_SetDacMode() ********************************/
/*!
...
void engine_sensor_adc_UABH_A_SetDacMode(CyUAB_dac_mode_enum dacMode)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_CAP_CTRL_PTR, 
      engine_sensor_adc_UABH_A_DAC_MODE_MASK, 
      ((uint32)dacMode), 
      engine_sensor_adc_UABH_A_DAC_MODE_SHIFT
    );    
}

/*************** engine_sensor_adc_UABH_A_SetDacNext() ********************************/
/*!
...
*
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_CAP_AB_VAL_NXT_REG.
...
void engine_sensor_adc_UABH_A_SetDacNext(int16 nextDACVal)
{
    ...
    uint32 val = ( ((uint32)nextDACVal) & ((uint32)engine_sensor_adc_UABH_A_DAC_NEXT_MASK) );
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_CAP_AB_VAL_NXT_PTR, 
      engine_sensor_adc_UABH_A_DAC_NEXT_MASK, 
      val, 
      engine_sensor_adc_UABH_A_CB_VAL_SHIFT
    );
}
...
/************** engine_sensor_adc_UABH_A_SetCapCFNext() *******************************/
/*!
...
*
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_CAP_CF_VAL_NXT_REG.
* This function is @b NOT generalized.  It depends on the 'next' values all
* being contiguous within a single register.
* @endinternal
* 
* @sideeffect None
*******************************************************************************/
void engine_sensor_adc_UABH_A_SetCapCFNext(CyUAB_cap_enum nextCapC,CyUAB_f_cap_enum nextCapF)
{
    const uint32 CF_VAL_PRESHIFT_MASK = ((uint32)(engine_sensor_adc_UABH_A_CF_VAL_MASK>>engine_sensor_adc_UABH_A_CF_VAL_SHIFT));
    const uint32 CC_VAL_PRESHIFT_MASK = ((uint32)(engine_sensor_adc_UABH_A_CC_VAL_MASK>>engine_sensor_adc_UABH_A_CC_VAL_SHIFT));
    const uint32 mask = ((uint32)engine_sensor_adc_UABH_A_CF_VAL_UPDATE_MASK) | ((uint32)engine_sensor_adc_UABH_A_CC_VAL_UPDATE_MASK) |
      ((uint32)engine_sensor_adc_UABH_A_CF_VAL_MASK) | ((uint32)engine_sensor_adc_UABH_A_CC_VAL_MASK);
    
    /* Also setting CF_VAL_UPDATE and CC_VAL_UPDATE bits */
    engine_sensor_adc_UABH_A_SET_VARIOUS_FIELDS(
      engine_sensor_adc_UABH_A_CAP_CF_VAL_NXT_PTR,
      mask,
      ((uint32)engine_sensor_adc_UABH_A_CF_VAL_UPDATE_MASK) | ((uint32)engine_sensor_adc_UABH_A_CC_VAL_UPDATE_MASK) |
        ( ( ((uint32)nextCapF) & CF_VAL_PRESHIFT_MASK)<<engine_sensor_adc_UABH_A_CF_VAL_SHIFT ) |
        ( ( ((uint32)nextCapC) & CC_VAL_PRESHIFT_MASK)<<engine_sensor_adc_UABH_A_CC_VAL_SHIFT ) 
	);
}
...
/*************** engine_sensor_adc_UABH_A_SetCompEdgeDetect() *************************/
/*!
...
*
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_OA0_CTRL_REG engine_sensor_adc_UABH_A_OA1_CTRL_REG
* @endinternal
* 
* 
* @see engine_sensor_adc_UABH_A_SetCompOutLevel()
* @see engine_sensor_adc_UABH_A_GetCompStatus()
* 
* @sideeffect None
*******************************************************************************/
void engine_sensor_adc_UABH_A_SetCompEdgeDetect(CyUAB_cmp_edge_enum detectMode)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_OA_CTRL_PTR, 
      engine_sensor_adc_UABH_A_CMP_EDGE_MASK, 
      ((uint32)detectMode), 
      engine_sensor_adc_UABH_A_CMP_EDGE_SHIFT
    );
}

/************ engine_sensor_adc_UABH_A_SetCompOutLevel ********************************/
/*!
...
* 
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_OA0_CTRL_REG
* @endinternal
* 
* @param isLevel
...
void engine_sensor_adc_UABH_A_SetCompOutLevel(CyUAB_cmp_level_enum isLevel)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_OA_CTRL_PTR, 
      engine_sensor_adc_UABH_A_CMP_DSI_LEVEL_MASK, 
      ((uint32)isLevel), 
      engine_sensor_adc_UABH_A_CMP_DSI_LEVEL_SHIFT
    );
}


/************  engine_sensor_adc_UABH_A_GetCompStatus() *******************************/
/*!
...
uint32 engine_sensor_adc_UABH_A_GetCompStatus(void)
{
    ...
    uint32 r = (0UL != ((*(engine_sensor_adc_UABH_A_STAT_PTR)) & engine_sensor_adc_UABH_A_COMP_MASK)) ? 1UL : 0UL;
    return r;    
}
...
/************** engine_sensor_adc_UABH_A_SetEarly() ***********************************/
/*!
...
*
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_SW_STATIC0_REG or engine_sensor_adc_UABH_A_SW_STATIC1_REG
* @image html _.png 
* @endinternal
* 
* @sideeffect None
...
void engine_sensor_adc_UABH_A_SetEarly(CyUAB_sw_id_enum sw_id, CyUAB_clk_adj_enum isEarly)
{
    ...
    {
        engine_sensor_adc_UABH_A_SET_FIELD(
          engine_sensor_adc_UABH_A_SW_STATIC_PTR, 
          engine_sensor_adc_UABH_A_EARLY_PS_MASK, 
          ((uint32)isEarly), 
          engine_sensor_adc_UABH_A_EARLY_PS_SHIFT
        ); 
    }
    else if( CyUAB_SW_PO==sw_id )
    {
        engine_sensor_adc_UABH_A_SET_FIELD(
          engine_sensor_adc_UABH_A_SW_STATIC_PTR, 
          engine_sensor_adc_UABH_A_EARLY_PO_MASK, 
          ((uint32)isEarly), 
          engine_sensor_adc_UABH_A_EARLY_PO_SHIFT
        );
    }
    else
    {
...
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_SRAM_CTRL_PTR,
      engine_sensor_adc_UABH_A_RUN_MASK, 
      flag, 
      engine_sensor_adc_UABH_A_RUN_SHIFT
    );    
}


/************** engine_sensor_adc_UABH_A_SetLastStep() ********************************/
/*!
...
* 
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_SRAM0_CTRL_REG
* @endinternal
* 
...
void engine_sensor_adc_UABH_A_SetLastStep(uint32 lastStep)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_SRAM_CTRL_PTR, 
      engine_sensor_adc_UABH_A_LAST_STEP_MASK,
      lastStep, 
      engine_sensor_adc_UABH_A_LAST_STEP_SHIFT
    );    
}

/******** engine_sensor_adc_UABH_A_SetStartupDelay() **********************************/
/*!
...
* 
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_STARTUP_DELAY0_REG
* @endinternal
* 
...
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_STARTUP_DELAY_PTR, 
      engine_sensor_adc_UABH_A_STARTUP_DELAY_MASK, 
      (uint32)delayCount, 
      engine_sensor_adc_UABH_A_STARTUP_DELAY_SHIFT
    );
}

/*********** engine_sensor_adc_UABH_A_SetAlignMode() **********************************/
/*!
...
*
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_STARTUP_DELAY0_REG , engine_sensor_adc_UABH_A_STARTUP_DELAY1_REG
* @endinternal
*
* 
* @sideeffect None
...
void engine_sensor_adc_UABH_A_SetAlignMode(CyUAB_align_mode_enum alignMode)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_STARTUP_DELAY_PTR, 
      engine_sensor_adc_UABH_A_ALIGN_MODE_MASK, 
      ((uint32)alignMode), 
      engine_sensor_adc_UABH_A_ALIGN_MODE_SHIFT
    );
}


/******** engine_sensor_adc_UABH_A_SetSubsample() *************************************/
/*!
...
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_SUBSAMPLE_CTRL_PTR, 
      engine_sensor_adc_UABH_A_SUBSAMPLE_MASK, 
      ((uint32)subsample), 
      engine_sensor_adc_UABH_A_SUBSAMPLE_SHIFT
    );
}

/***************  engine_sensor_adc_UABH_A_SetSubsampleInit() *************************/
/*!
...
void engine_sensor_adc_UABH_A_SetSubsampleInit(uint8 subsampleInit)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_SUBSAMPLE_CTRL_PTR, 
      engine_sensor_adc_UABH_A_SUBSAMPLE_INIT_MASK, 
      ((uint32)subsampleInit), 
      engine_sensor_adc_UABH_A_SUBSAMPLE_INIT_SHIFT
    );
}


/************* engine_sensor_adc_UABH_A_GetCurrentSubsample() *************************/
/*!
...
{
    return engine_sensor_adc_UABH_A_GET_FIELD(
      engine_sensor_adc_UABH_A_STAT_PTR,
      engine_sensor_adc_UABH_A_CURR_SUBSAMPLE_MASK,
      engine_sensor_adc_UABH_A_CURR_SUBSAMPLE_SHIFT
    );
}

/************** engine_sensor_adc_UABH_A_GetCurrentStep() *****************************/
/*!
* @brief Get currStep
* 
* @details
...
uint32 engine_sensor_adc_UABH_A_GetCurrentStep(void)
{
    return engine_sensor_adc_UABH_A_GET_FIELD(
      engine_sensor_adc_UABH_A_STAT_PTR,
      engine_sensor_adc_UABH_A_CURR_STEP_MASK,
      engine_sensor_adc_UABH_A_CURR_STEP_SHIFT
    );
}


/**************** engine_sensor_adc_UABH_A_SetModbitSource() **************************/
/*!
...
* 
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_SW_MODBIT_SRC0 , engine_sensor_adc_UABH_A_SW_MODBIT_SRC1
* @endinternal
* 
...
{
    /*mask input values before shifting to prevent overlap*/
    const uint32 MODBIT_SRC_AB_PRESHIFT_MASK = engine_sensor_adc_UABH_A_MODBIT0_SRC_SEL_MASK>>engine_sensor_adc_UABH_A_MODBIT0_SRC_SEL_SHIFT;
    const uint32 MODBIT_SRC_C_PRESHIFT_MASK = engine_sensor_adc_UABH_A_MODBIT1_SRC_SEL_MASK>>engine_sensor_adc_UABH_A_MODBIT1_SRC_SEL_SHIFT;
    engine_sensor_adc_UABH_A_SET_VARIOUS_FIELDS(
      engine_sensor_adc_UABH_A_SW_MODBIT_SRC_PTR,
      engine_sensor_adc_UABH_A_MODBIT1_SRC_SEL_MASK | engine_sensor_adc_UABH_A_MODBIT0_SRC_SEL_MASK,
      (uint32)( 
        ( (modbitSrcAB & MODBIT_SRC_AB_PRESHIFT_MASK) <<engine_sensor_adc_UABH_A_MODBIT0_SRC_SEL_SHIFT ) | 
        ( (modbitSrcC &MODBIT_SRC_C_PRESHIFT_MASK) <<engine_sensor_adc_UABH_A_MODBIT1_SRC_SEL_SHIFT ) 
      )
    );    
}


/********************** engine_sensor_adc_UABH_A_SetStrobeMode ************************/
/*!
...
void engine_sensor_adc_UABH_A_SetStrobeMode(CyUAB_strobe_mode_enum strobeMode)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_SW_STATIC_PTR, 
      engine_sensor_adc_UABH_A_STRB_RST_EN_MASK, 
      ((uint32)strobeMode), 
      engine_sensor_adc_UABH_A_STRB_RST_EN_SHIFT
    );
}

/*********** engine_sensor_adc_UABH_A_SetStrobeSource *********************************/
/*!
...
@internal
@reglist @reg engine_sensor_adc_UABH_A_SW_STATIC0_REG.STRB_RST0_SEL or engine_sensor_adc_UABH_A_SW_STATIC1_REG.STRB_RST1_SEL
@endinternal
...
void engine_sensor_adc_UABH_A_SetStrobeSource(uint32 strobeSource)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_SW_STATIC_PTR, 
      engine_sensor_adc_UABH_A_STRB_RST_SEL_MASK, 
      strobeSource, 
      engine_sensor_adc_UABH_A_STRB_RST_SEL_SHIFT
    );
}


/************ engine_sensor_adc_UABH_A_SetFirmwareModbit() ****************************/
/*!
* @brief Set the firmware modbit.
* 
* @details This function sets the firmware modbit. The modbit affects several 
* clocks.  If firmware modbit is selected (Use engine_sensor_adc_UABH_A_SetModbitSource() choice 31),
...
void engine_sensor_adc_UABH_A_SetFirmwareModbit(uint32 flag)
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_CAP_ABCF_VAL_PTR, 
      engine_sensor_adc_UABH_A_SIGN_VAL_MASK,
      (uint32)flag, 
      engine_sensor_adc_UABH_A_SIGN_VAL_SHIFT
    );
}


/************* engine_sensor_adc_UABH_A_SetInputTrigger() *****************************/
/*!
...
* which trigger to use.  Trigger state is irrelevant if engine_sensor_adc_UABH_A_EnableClocks()
* has not been called.
* 
* @internal
* @reglist @reg engine_sensor_adc_UABH_A_SRAM0_CTRL_REG engine_sensor_adc_UABH_A_SRAM1_CTRL_REG
* @endinternal
* 
* @param triggerEn Enables the input trigger.  If 0, trigger signal is ignored,
* and the SRAM clocks will start running as soon as the engine_sensor_adc_UABH_A_EnableClocks()
...
* For PSoC4400, only values 0-1, 8-13, and 31 are valid.
*
* @see engine_sensor_adc_UABH_A_EnableClocks()
* 
* @sideeffect None
*******************************************************************************/
...
{
    /*mask input values before shifting to prevent overlap*/
    const uint32 TRIG_SEL_PRESHIFT_MASK = engine_sensor_adc_UABH_A_TRIG_SEL_MASK>>engine_sensor_adc_UABH_A_TRIG_SEL_SHIFT;
    const uint32 TRIGGER_EN_PRESHIFT_MASK = engine_sensor_adc_UABH_A_TRIGGER_EN_MASK>>engine_sensor_adc_UABH_A_TRIGGER_EN_SHIFT;
    engine_sensor_adc_UABH_A_SET_VARIOUS_FIELDS(
      engine_sensor_adc_UABH_A_SRAM_CTRL_PTR,
      engine_sensor_adc_UABH_A_TRIG_SEL_MASK | engine_sensor_adc_UABH_A_TRIGGER_EN_MASK,
      ( (triggerSel & TRIG_SEL_PRESHIFT_MASK) <<engine_sensor_adc_UABH_A_TRIG_SEL_SHIFT   ) | 
      ( (triggerEn & TRIGGER_EN_PRESHIFT_MASK) <<engine_sensor_adc_UABH_A_TRIGGER_EN_SHIFT )
    );
}


/****************** engine_sensor_adc_UABH_A_SetStaticSwitch() ************************/
/*!
...
{   
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_GetStaticSwAddr( (sw_id) ), 
      engine_sensor_adc_UABH_A_StaticSwMask( (sw_id) ),
      CyUAB_SwIsClosed( (clk) ), 
      engine_sensor_adc_UABH_A_StaticSwShift( (sw_id) )
    );
}


/******************** engine_sensor_adc_UABH_A_SetSwitch() ****************************/
/*!
...
{
    engine_sensor_adc_UABH_A_SET_FIELD(
      engine_sensor_adc_UABH_A_GetDynamicSwAddr( (sw_id) ),
      engine_sensor_adc_UABH_A_DynamicSwMask( (sw_id) ),
      ((uint32)((clk))), 
      engine_sensor_adc_UABH_A_DynamicSwShift( (sw_id) )
    ); 
}
